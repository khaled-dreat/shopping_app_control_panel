...
class AppTheme {
  ...
  // TODO : static String textTheme(BuildContext context) =>
  // TODO :     isDark(context) ? AppLangKey.dark.tr() : AppLangKey.light.tr();
  // * return color depend on theme
  // TODO : static Color themeColor(BuildContext context) =>
  // TODO :     isDark(context) ? AppColors.darkMode : AppColors.lightMode;
